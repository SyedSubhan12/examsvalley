...
//   Google OAuth → expo-auth-session (Google.useAuthRequest) → AuthContext.loginWithGoogle (mobile
//   cannot use the web's GET /api/auth/google redirect). On success the backend creates/links the
